    ...
    <div className="container">
      <div className="home-content text-center mb-5">
        <div className="card-body">
          <h1>ברוכים הבאים</h1>
          <h5 className="card-title">מתנות שזורמות בקלות</h5>
          <form onSubmit={handleSubmit} className="mb-2 mt-2 mr-2 ml-2">
            ...
            />
            <br/><br/>
            <button type="submit" className="btn btn-primary form-btn">התחברות</button>
          ...
          <div>
            ...
            <p className="sign-up-label">
              <span className="sign-up-link">שכחתי סיסמה</span>
            </p>
            <p className="sign-up-label">
